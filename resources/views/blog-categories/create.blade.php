            ...
            <x-slot name="header">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="bg-white rounded-lg shadow">
                        <div class="px-6 py-4">
                            <h1 class="text-3xl font-bold text-gray-900 mb-4">Add Blog Category</h1>
                            <hr class="mb-6">
                            ...
                            <form action="{{ route('blog-categories.store') }}" method="POST">
                                ...
                                <div class="flex gap-3">
                                    <button type="submit" style="background-color: #9797df"
                                        class="bg-blue-600 hover:bg-blue-700 text-black border border-blue-700  font-semibold py-2 px-6 rounded-md">Create
                                        Blog
                                        Category</button>
                                    <a href="{{ route('categories.index') }}" style="background-color: #e90e0e"
                                        class="bg-gray-400 hover:bg-gray-500 text-black font-semibold py-2 px-6 rounded-md">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
