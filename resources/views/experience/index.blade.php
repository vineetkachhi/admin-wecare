                            ...
                            <tbody class="divide-y">
                                @forelse($experiences as $experience)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4">{{ $experience->id }}</td>
                                        <td class="px-6 py-4">{{ $experience->heading }}</td>
                                        <td class="px-6 py-4">
                                            {{ \Illuminate\Support\Str::limit(strip_tags($experience->description), 100) }}
                                        </td>
                                        <td class="px-6 py-4">
                                            <span
                                                class="inline-block px-3 py-1 rounded-full text-sm font-semibold {{ $experience->status == 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">No Experience
                                            found
                                        </td>
                                    </tr>
                                @endforelse
