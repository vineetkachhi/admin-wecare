            ...
            <x-slot name="header">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="bg-white rounded-lg shadow">
                        <div class="px-6 py-4">
                            <h1 class="text-3xl font-bold text-gray-900 mb-4">Edit Experience</h1>
                            <hr class="mb-6">
                            ...
                            <form action="{{ route('experience.update', $experience->id) }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        class="w-full px-4 py-2 border @error('heading') border-red-500 @else border-gray-300 @enderror rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        id="heading" name="heading" value="{{ $experience->heading }}" required>
                                    @error('heading')
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea
                                        ...
                                        id="summernote" name="description" rows="5" required>{{ $experience->description }}</textarea>
                                    @error('description')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select
                                        ...
                                        <option value="inactive"
                                            {{ $experience->status == 'inactive' ? 'selected' : '' }}>
                                            Inactive</option>
                                    </select>
                                    @error('status')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                ...
                                <div class="flex gap-3">
                                    <button type="submit" style="background-color: #9797df"
                                        ...
                                        Experience</button>
                                    <a href="{{ route('experience.index') }}" style="background-color: #e90e0e"
