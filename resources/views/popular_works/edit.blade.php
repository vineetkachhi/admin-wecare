            ...
            <x-slot name="header">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="bg-white rounded-lg shadow">
                        <div class="px-6 py-4">
                            <h1 class="text-3xl font-bold text-gray-900 mb-4">Edit Popular Work</h1>
                            <hr class="mb-6">
                            ...
                            <form action="{{ route('popular_work.update', $popular_work->id) }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        id="title" name="title" value="{{ $popular_work->title }}" required>
                                    @error('title')
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        id="summernote" name="description" rows="6" required>{{ $popular_work->description }}</textarea>
                                    @error('description')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="flex gap-3 mt-6">
                                    <button type="submit" style="background-color: #9797df"
                                        ...
                                        Popular Work</button>
                                    <a href="{{ route('popular_work.index') }}" style="background-color: #e90e0e"
