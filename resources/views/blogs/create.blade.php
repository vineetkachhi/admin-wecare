            ...
            <x-slot name="header">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="bg-white rounded-lg shadow">
                        <div class="px-6 py-4">
                            <h1 class="text-3xl font-bold text-gray-900 mb-4">Add Blog</h1>
                            <hr class="mb-6">
                                ...
                                <div class="border-t pt-6 mt-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            id="seo_description" name="seo_description" rows="3" placeholder="Max 500 characters">{{ old('seo_description') }}</textarea>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <textarea
                                            ...
                                            id="seo_meta_tag" name="seo_meta_tag" rows="3" placeholder="Comma separated keywords">{{ old('seo_meta_tag') }}</textarea>
                                        @error('seo_meta_tag')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
